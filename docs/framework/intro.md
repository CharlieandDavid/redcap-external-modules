...
createQuery() | `9.7.8`<br>`2` | Creates a `Query` object to aid in building complex queries using parameters.  See the [Query Documentation](../querying.md) page for more details.
