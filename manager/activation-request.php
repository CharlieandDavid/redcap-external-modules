...
if (isset($enabledModules[$prefix])) exit("ERROR: External module \"{$config['name']}\" is already enabled for this project!");
    ...
    <table class="table table-no-top-row-border">
        <tr data-module="<?=$prefix?>" data-version="<?=$version?>">
            ...
            <td class="external-modules-action-buttons align-middle">
                <button class="enable-button"><?=ExternalModules::tt("em_manage_59", $config['name'])?></button>
            </td>
        </tr>
    </table>
</div>
